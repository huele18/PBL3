...
namespace PBL3.GUI
{
    public partial class fBillManager : Form
    {
        ...
        public void setDGV()
        {
            ...
            //{
            //    string s = dgvInvoice.Rows[i].Cells["orderedDrink"].Value.ToString();
        ...
        private void dgvInvoice_RowHeaderMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            //    string s = dgvInvoice.Rows[index].Cells["orderedDrink"].Value.ToString();
            //    cbborder.DataSource = null;
            //    cbborder.DataSource = Bill_BLL.Instance.getOrderedDrinnkCBB(s);
            //    string tongtien = Bill_BLL.Instance.getTotal(s).ToString();
            //    total.Text = tongtien;
